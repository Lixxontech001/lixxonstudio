  ...
  return (
    <section className="container-narrow py-16 md:py-24">
      ...
      <div className="article-prose mt-12">
        ...
        <p>
          Every article published on Lixxon Studio is held to the same standard. We cite peer-reviewed research where applicable, consult with dermatologists and clinicians for medical claims, and test products for a minimum of four weeks before reviewing them. We do not accept paid placements, and our affiliate relationships never influence which products we recommend — if we would not use it ourselves, we will not recommend it to you.
        </p>
        <p>
          Our writers are not content marketers. They are beauty editors with years of experience in clinical skincare, style directors who have dressed real people for real lives, and wellness practitioners who understand the difference between a wellness trend and an evidence-based habit.
        </p>

        <h2>Our Promise</h2>
        <p>
          No clickbait. No fear-mongering. No ten-step routines you will abandon in a week. Just clear, expert guidance for a more intentional daily life, written by people who live and breathe this work. We will never tell you that a single product will change your life. We will tell you which products are worth your money, which habits are worth your time, and which trends you can safely ignore.
        </p>

        <h2>The Daily Reset</h2>
        <p>
          Each morning, we publish a carefully edited selection of stories designed to be read in the time it takes to finish your coffee. The Daily Reset newsletter distills this further — a single email with the day's most worth-your-attention piece, delivered before your inbox fills with noise. Twelve thousand readers have made it part of their morning. We would love for you to join them.
        </p>

        <h2>Join Us</h2>
        <p>
          Whether you are starting your first skincare routine, refining a capsule wardrobe, or simply looking for a calmer morning, we are glad you are here. Explore our latest stories, subscribe to The Daily Reset for a curated edit in your inbox each morning, or reach out to our editorial team with a story you would like us to tell.
        </p>

        <div className="mt-8 not-prose flex flex-col sm:flex-row gap-4">
          <button
            onClick={() => navigate({ name: 'home' })}
            className="inline-flex items-center justify-center gap-3 px-8 py-4 bg-charcoal text-white text-xs tracking-editorial uppercase font-medium hover:bg-bronze transition-all duration-500 rounded-sm"
          >
